		...
		<div class="breadcrumbs">
			<div class="container">
				...
				<ul class="pull-right breadcrumb">
					...
					<li><a href="?pg=abre_chamado">Abre Chamado</a></li>
...
****************************************************************************************************************************************** -->
	...
	<div class="container content">
		<!-- Login-Form -->
        <div class="col-md-20">
            <form id="sky-form4" class="sky-form" name="cadusuario" method="post" action="include/chamado.php?funcao=abre_chamado" >
			...
			<? 
				...
				while($linha = mysql_fetch_array($sql)){
					...
					<tr>
							<td>
								<? if($situacao != "FECHADO"){ ?>
									<? if ($nome_usuario_logado == $linha['nome_usuario'] || $filt_chamado_fecha == 1){?>
									...
									<? if ($filt_chamado_fecha == 1){?>
										<a href="mailto:<? echo $linha['email'];?>
											?subject=TI Benassi Rio - Chamado: <? echo $linha['id'];?>
											&body=Descrição Chamado: <? echo $linha['descricao'];?>
											">
											<button class="btn btn-warning btn-sm rounded-2x">
						...
						<td>
							<? if ( $linha['solucao'] == "ABERTO" ){ ?>
									<span class="label label-success btn-sm ">
										<? echo $linha['solucao'];?>
									</span>
							<? }?>
							<? if ( $linha['solucao'] == "andamento" ){ ?>
							...
							<? }?>
							<? if ( $linha['situacao'] == "FECHADO" and $linha['solucao'] == "Concluido" ){ ?>
									<span class="label label-success btn-sm ">
										<? echo $linha['solucao'];?>
									</span>
							<? }?>
							<? if ( $linha['situacao'] == "FECHADO" and $linha['solucao'] == "Não Concluido" ){ ?>
									<span class="label label-danger btn-sm ">
										<? echo $linha['solucao'];?>
									</span>
							<? }?>
							<? if ( $linha['situacao'] == "FECHADO" and $linha['solucao'] == "REJEITADO" ){ ?>
									<span class="label label-danger btn-sm ">
										<? echo $linha['solucao'];?>
									</span>
							<? }?>
