...
if($cont == 0){//confere o usuario
	...
	//=========== Insere os dados para relatórios de acesso.
	$data_atual = date("d/m/Y");
	$hora_atual = date("H:i");
	$sql_rel_login =	"insert into rel_login 
	(login_usuario , id_usuario , data_login , hora_login) values
	('$login' , '$id_funcionario' , now() , now())"; 
	mysql_query($sql_rel_login);
	//=========== Fim Insere os dados para relatórios de acesso.
	echo"
