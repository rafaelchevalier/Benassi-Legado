...
utf8_decode($_REQUEST['galpao_manutencao_hidraulica']),
utf8_decode($_REQUEST['galpao_manutencao_hidraulica_balanca_obs']),
//BANHEIRO MASCULINO
...
//PROCESSADOS	
utf8_decode($_REQUEST['processados_teto']),
utf8_decode($_REQUEST['processados_teto_obs']),
utf8_decode($_REQUEST['processados_luminaria']),
utf8_decode($_REQUEST['processados_luminaria_obs']),
utf8_decode($_REQUEST['processados_parede']),
utf8_decode($_REQUEST['processados_parede_obs']),
utf8_decode($_REQUEST['processados_porta']),
utf8_decode($_REQUEST['processados_porta_obs']),
utf8_decode($_REQUEST['processados_fiacao']),
utf8_decode($_REQUEST['processados_fiacao_obs']),
utf8_decode($_REQUEST['processados_balanca']),
utf8_decode($_REQUEST['processados_balanca_obs']),
utf8_decode($_REQUEST['processados_utensilio']),
utf8_decode($_REQUEST['processados_utensilio_obs']),
utf8_decode($_REQUEST['processados_dispenser']),
utf8_decode($_REQUEST['processados_dispenser_obs']),
utf8_decode($_REQUEST['processados_pia']),
utf8_decode($_REQUEST['processados_pia_obs']),
utf8_decode($_REQUEST['processados_lixeira']),
utf8_decode($_REQUEST['processados_lixeira_obs']),
utf8_decode($_REQUEST['processados_isca']),
utf8_decode($_REQUEST['processados_isca_obs']),
//ZONASUL
utf8_decode($_REQUEST['zona_sul_teto']),
utf8_decode($_REQUEST['zona_sul_teto_obs']),
utf8_decode($_REQUEST['zona_sul_luminaria']),
utf8_decode($_REQUEST['zona_sul_luminaria_obs']),
utf8_decode($_REQUEST['zona_sul_parede']),
utf8_decode($_REQUEST['zona_sul_parede_obs']),
utf8_decode($_REQUEST['zona_sul_porta']),
utf8_decode($_REQUEST['zona_sul_porta_obs']),
utf8_decode($_REQUEST['zona_sul_fiacao']),
utf8_decode($_REQUEST['zona_sul_fiacao_obs']),
utf8_decode($_REQUEST['zona_sul_balanca']),
utf8_decode($_REQUEST['zona_sul_balanca_obs']),
utf8_decode($_REQUEST['zona_sul_computador']),
utf8_decode($_REQUEST['zona_sul_computador_obs']),
utf8_decode($_REQUEST['zona_sul_lixeira']),
utf8_decode($_REQUEST['zona_sul_lixeira_obs']),
//DATAS - USUARIO
...
$galpao_manutencao_hidraulica,
$galpao_manutencao_hidraulica_balanca_obs,
...
$processados_teto,
$processados_teto_obs,
$processados_luminaria,
$processados_luminaria_obs,
$processados_parede,
$processados_parede_obs,
$processados_porta,
$processados_porta_obs,
$processados_fiacao,
$processados_fiacao_obs,
$processados_balanca,
$processados_balanca_obs,
$processados_utensilio,
$processados_utensilio_obs,
$processados_dispenser,
$processados_dispenser_obs,
$processados_pia,
$processados_pia_obs,
$processados_lixeira,
$processados_lixeira_obs,
$processados_isca,
$processados_isca_obs,
$zona_sul_teto,
$zona_sul_teto_obs,
$zona_sul_luminaria,
$zona_sul_luminaria_obs,
$zona_sul_parede,
$zona_sul_parede_obs,
$zona_sul_porta,
$zona_sul_porta_obs,
...
$zona_sul_fiacao_obs,
$zona_sul_balanca,
$zona_sul_balanca_obs,
$zona_sul_computador,
$zona_sul_computador_obs,
$zona_sul_lixeira,
$zona_sul_lixeira_obs,
$usuario,
$data_verificacao,
$data
)
...
if ($galpao_manutencao_hidraulica == 0 ){ $nc ++; $total_item ++;}
...
if ($processados_teto == 0 ){ $nc ++; $total_item ++; }
if ($processados_luminaria == 0 ){ $nc ++; $total_item ++; }
if ($processados_parede == 0 ){ $nc ++; $total_item ++; }
if ($processados_porta == 0 ){ $nc ++; $total_item ++; }
if ($processados_fiacao == 0 ){ $nc ++; $total_item ++; }
if ($processados_balanca == 0 ){ $nc ++; $total_item ++; }
if ($processados_utensilio == 0 ){ $nc ++; $total_item ++; }
if ($processados_dispenser == 0 ){ $nc ++; $total_item ++;}
if ($processados_pia == 0 ){ $nc ++; $total_item ++;}
if ($processados_lixeira == 0 ){ $nc ++; $total_item ++;}
if ($processados_isca == 0 ){ $nc ++; $total_item ++;}
if ($zona_sul_teto == 0 ){ $nc ++; $total_item ++;}
if ($zona_sul_luminaria == 0 ){ $nc ++; $total_item ++;}
if ($zona_sul_parede == 0 ){ $nc ++; $total_item ++;}
if ($zona_sul_porta == 0 ){ $nc ++; $total_item ++;}
if ($zona_sul_fiacao == 0 ){ $nc ++; $total_item ++;}
if ($zona_sul_balanca == 0 ){ $nc ++; $total_item ++;}
if ($zona_sul_computador == 0 ){ $nc ++; $total_item ++;}
if ($zona_sul_lixeira == 0 ){ $nc ++; $total_item ++;}
...
if ($galpao_manutencao_hidraulica == 1 ){ $c ++; $total_item ++;}
...
if ($processados_teto == 1 ){ $c ++; $total_item ++;}
if ($processados_luminaria == 1 ){ $c ++; $total_item ++;}
if ($processados_parede == 1 ){ $c ++; $total_item ++;}
if ($processados_porta == 1 ){ $c ++; $total_item ++;}
if ($processados_fiacao == 1 ){ $c ++; $total_item ++;}
if ($processados_balanca == 1 ){ $c ++; $total_item ++;}
if ($processados_utensilio == 1 ){ $c ++; $total_item ++;}
if ($processados_dispenser == 1 ){ $c ++; $total_item ++;}
if ($processados_pia == 1 ){ $c ++; $total_item ++;}
if ($processados_lixeira == 1 ){ $c ++; $total_item ++;}
if ($processados_isca == 1 ){ $c ++; $total_item ++;}
if ($zona_sul_teto == 1 ){ $c ++; $total_item ++;}
if ($zona_sul_luminaria == 1 ){ $c ++; $total_item ++;}
if ($zona_sul_parede == 1 ){ $c ++; $total_item ++;}
if ($zona_sul_porta == 1 ){ $c ++; $total_item ++;}
if ($zona_sul_fiacao == 1 ){ $c ++; $total_item ++;}
if ($zona_sul_balanca == 1 ){ $c ++; $total_item ++;}
if ($zona_sul_computador == 1 ){ $c ++; $total_item ++;}
if ($zona_sul_lixeira == 1 ){ $c ++; $total_item ++;}
...
if ($galpao_manutencao_hidraulica == 0 ){
	$sql_clp_nc = "insert into clp_nc 
	(descricao,obs,situacao,data_identificacao,usuario_identificacao,data_cad,hora_cad,usuario_cad) 
	values 
	('galpao_manutencao_hidraulica','$galpao_manutencao_hidraulica_balanca_obs','$galpao_manutencao_hidraulica','$data','$usuario',now(),now(),'$usuario')";
	mysql_query($sql_clp_nc);
	}	
...
if ($processados_teto == 0 ){
	$sql_clp_nc = "insert into clp_nc 
	(descricao,obs,situacao,data_identificacao,usuario_identificacao,data_cad,hora_cad,usuario_cad) 
	values 
	('processados_teto','$processados_teto_obs','$processados_teto','$data','$usuario',now(),now(),'$usuario')";
	mysql_query($sql_clp_nc);
	}
if ($processados_luminaria == 0 ){
	$sql_clp_nc = "insert into clp_nc 
	(descricao,obs,situacao,data_identificacao,usuario_identificacao,data_cad,hora_cad,usuario_cad) 
	values 
	('processados_luminaria','$processados_luminaria_obs','$processados_luminaria','$data','$usuario',now(),now(),'$usuario')";
	mysql_query($sql_clp_nc);
	}
if ($processados_parede == 0 ){
	$sql_clp_nc = "insert into clp_nc 
	(descricao,obs,situacao,data_identificacao,usuario_identificacao,data_cad,hora_cad,usuario_cad) 
	values 
	('processados_parede','$processados_parede_obs','$processados_parede','$data','$usuario',now(),now(),'$usuario')";
	mysql_query($sql_clp_nc);
	}
if ($processados_porta == 0 ){
	$sql_clp_nc = "insert into clp_nc 
	(descricao,obs,situacao,data_identificacao,usuario_identificacao,data_cad,hora_cad,usuario_cad) 
	values 
	('processados_porta','$processados_porta_obs','$processados_porta','$data','$usuario',now(),now(),'$usuario')";
	mysql_query($sql_clp_nc);
	}
if ($processados_fiacao == 0 ){
	$sql_clp_nc = "insert into clp_nc 
	(descricao,obs,situacao,data_identificacao,usuario_identificacao,data_cad,hora_cad,usuario_cad) 
	values 
	('processados_fiacao','$processados_fiacao_obs','$processados_fiacao','$data','$usuario',now(),now(),'$usuario')";
	mysql_query($sql_clp_nc);
	}
if ($processados_balanca == 0 ){
	$sql_clp_nc = "insert into clp_nc 
	(descricao,obs,situacao,data_identificacao,usuario_identificacao,data_cad,hora_cad,usuario_cad) 
	values 
	('processados_balanca','$processados_balanca_obs','$processados_balanca','$data','$usuario',now(),now(),'$usuario')";
	mysql_query($sql_clp_nc);
	}
if ($processados_utensilio == 0 ){
	$sql_clp_nc = "insert into clp_nc 
	(descricao,obs,situacao,data_identificacao,usuario_identificacao,data_cad,hora_cad,usuario_cad) 
	values 
	('processados_utensilio','$processados_utensilio_obs','$processados_utensilio','$data','$usuario',now(),now(),'$usuario')";
	mysql_query($sql_clp_nc);
	}
if ($processados_dispenser == 0 ){
	$sql_clp_nc = "insert into clp_nc 
	(descricao,obs,situacao,data_identificacao,usuario_identificacao,data_cad,hora_cad,usuario_cad) 
	values 
	('processados_dispenser','$processados_dispenser_obs','$processados_dispenser','$data','$usuario',now(),now(),'$usuario')";
	mysql_query($sql_clp_nc);
	}
if ($processados_pia == 0 ){
	$sql_clp_nc = "insert into clp_nc 
	(descricao,obs,situacao,data_identificacao,usuario_identificacao,data_cad,hora_cad,usuario_cad) 
	values 
	('processados_pia','$processados_pia_obs','$processados_pia','$data','$usuario',now(),now(),'$usuario')";
	mysql_query($sql_clp_nc);
	}
if ($processados_lixeira == 0 ){
	$sql_clp_nc = "insert into clp_nc 
	(descricao,obs,situacao,data_identificacao,usuario_identificacao,data_cad,hora_cad,usuario_cad) 
	values 
	('processados_lixeira','$processados_lixeira_obs','$processados_lixeira','$data','$usuario',now(),now(),'$usuario')";
	mysql_query($sql_clp_nc);
	}
if ($processados_isca == 0 ){
	$sql_clp_nc = "insert into clp_nc 
	(descricao,obs,situacao,data_identificacao,usuario_identificacao,data_cad,hora_cad,usuario_cad) 
	values 
	('processados_isca','$processados_isca_obs','$processados_isca','$data','$usuario',now(),now(),'$usuario')";
	mysql_query($sql_clp_nc);
	}
//****************************** Fim Processados *********************************
//****************************** Inicio Zona Zul *********************************
if ($zona_sul_teto == 0 ){
	...
	(descricao,obs,situacao,data_identificacao,usuario_identificacao,data_cad,hora_cad,usuario_cad) 
	values 
	('zona_sul_teto','$zona_sul_teto_obs','$zona_sul_teto','$data','$usuario',now(),now(),'$usuario')";
	mysql_query($sql_clp_nc);
	}
if ($zona_sul_luminaria == 0 ){
	$sql_clp_nc = "insert into clp_nc 
	(descricao,obs,situacao,data_identificacao,usuario_identificacao,data_cad,hora_cad,usuario_cad) 
	values 
	('zona_sul_luminaria','$zona_sul_luminaria_obs','$zona_sul_luminaria','$data','$usuario',now(),now(),'$usuario')";
	mysql_query($sql_clp_nc);
	}
if ($zona_sul_parede == 0 ){
	$sql_clp_nc = "insert into clp_nc 
	(descricao,obs,situacao,data_identificacao,usuario_identificacao,data_cad,hora_cad,usuario_cad) 
	values 
	('zona_sul_parede','$zona_sul_parede_obs','$zona_sul_parede','$data','$usuario',now(),now(),'$usuario')";
	mysql_query($sql_clp_nc);
	}
if ($zona_sul_porta == 0 ){
	$sql_clp_nc = "insert into clp_nc 
	(descricao,obs,situacao,data_identificacao,usuario_identificacao,data_cad,hora_cad,usuario_cad) 
	values 
	('zona_sul_porta','$zona_sul_porta_obs','$zona_sul_porta','$data','$usuario',now(),now(),'$usuario')";
	mysql_query($sql_clp_nc);
	}
if ($zona_sul_fiacao == 0 ){
	$sql_clp_nc = "insert into clp_nc 
	(descricao,obs,situacao,data_identificacao,usuario_identificacao,data_cad,hora_cad,usuario_cad) 
	values 
	('zona_sul_fiacao','$zona_sul_fiacao_obs','$zona_sul_fiacao','$data','$usuario',now(),now(),'$usuario')";
	mysql_query($sql_clp_nc);
	}
if ($zona_sul_balanca == 0 ){
	$sql_clp_nc = "insert into clp_nc 
	(descricao,obs,situacao,data_identificacao,usuario_identificacao,data_cad,hora_cad,usuario_cad) 
	values 
	('zona_sul_balanca','$zona_sul_balanca_obs','$zona_sul_balanca','$data','$usuario',now(),now(),'$usuario')";
	mysql_query($sql_clp_nc);
	}
if ($zona_sul_computador == 0 ){
	$sql_clp_nc = "insert into clp_nc 
	(descricao,obs,situacao,data_identificacao,usuario_identificacao,data_cad,hora_cad,usuario_cad) 
	values 
	('zona_sul_computador','$zona_sul_computador_obs','$zona_sul_computador','$data','$usuario',now(),now(),'$usuario')";
	mysql_query($sql_clp_nc);
	}
if ($zona_sul_lixeira == 0 ){
	$sql_clp_nc = "insert into clp_nc 
	(descricao,obs,situacao,data_identificacao,usuario_identificacao,data_cad,hora_cad,usuario_cad) 
	values 
	('zona_sul_lixeira','$zona_sul_lixeira_obs','$zona_sul_lixeira','$data','$usuario',now(),now(),'$usuario')";
	mysql_query($sql_clp_nc);
	}
//***************************** Fim Zona Sul *****************************************	
