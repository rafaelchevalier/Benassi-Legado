		...
		<div class="panel panel-sea margin-bottom-12">
			...
			<form action="include/pir.php?funcao=cad" method="post" id="sky-form" class="sky-form" enctype="multipart/form-data">
				<fieldset>      
					<div class="row">
						<div class="col col-2">
							<label>Início de uso</label>
							<label class="input">
								<i class="icon-append fa fa-calendar"></i>
								<input type="text" autocomplete="off" name="data" id="start" required value="<? if (!empty($_REQUEST['data'])){echo $_REQUEST['data'];}if (empty($_REQUEST['data'])){echo converte_data2($data_atual);}?>" required onkeypress="autoTab(this, event); return event.keyCode != 13;" title="Data">
							</label>
						</div>
						<div class="col col-2">
							<label>Término de uso</label>
							<label class="input">
								<i class="icon-append fa fa-calendar"></i>
								<input type="text" autocomplete="off" name="fim_uso" id="finish" required value="<? if (!empty($_REQUEST['fim_uso'])){echo $_REQUEST['fim_uso'];}if (empty($_REQUEST['fim_uso'])){echo converte_data2($data_atual);}?>" required onkeypress="autoTab(this, event); return event.keyCode != 13;" title="">
							</label>
						</div>							
						<div class="col col-4">
							<label>Empresa</label>
					...
					<fieldset>      
						<div class="row">
							...
							<div class="col col-2">
								...
								<label class="input">
									<i class="icon-append fa fa-calendar"></i>
									<input type="text" autocomplete="off" name="data" id="date1" required value="<? echo converte_data2($linha['data'])?>" required onkeypress="autoTab(this, event); return event.keyCode != 13;" title="Início">
								</label>
							</div>	
							<div class="col col-2">
								<label>Término de uso</label>
								<label class="input">
									<i class="icon-append fa fa-calendar"></i>
									<input type="text" autocomplete="off" name="fim_uso" id="finish" required value="<? echo converte_data2($linha['fim_uso'])?>" required onkeypress="autoTab(this, event); return event.keyCode != 13;" title="Fim">
								</label>
							</div>	
							<div class="col col-4">
								<label>Empresa</label>
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td><? echo converte_data($linha['data'])." - ". converte_data($linha['fim_uso'])?></td>
