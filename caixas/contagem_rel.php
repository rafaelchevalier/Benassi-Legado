...
while($linha = mysql_fetch_array($sql)){
	...
	$pdf->SetFont('Arial','B','9');//FORMATAÇÃO TEXTO 
   	...
   	$pdf->Cell(5,0.5,"Total lojas Filtradas",0,0,'L',1); 
	$pdf->Cell(6.5,0.5,$total_loja,0,0,'C',1); 
...
$pdf->Close();
$pdf->Output('rel.pdf','D');
// *********************** fim Relatório fpdf contagem *************************

//********************************************************************************************************************
//											Inicio Módulo Envio de E-mail
//********************************************************************************************************************
if(empty($_POST['email_envio']))
$email_envio = "rafael@rasp.net.br";
if(!empty($_POST['email_envio']))
...
$subject = "Relatório Caixa Plástica por Período: ".$data_atual."  -  ".$data_atual; 
...
// attachment name
$filename = "Relatorio Diario ".$data_atual."   ".$data_atual.".pdf";
