...
<?	if ( isset($_SESSION['mercado_cnpj']) and $pg =="tipo" ) {//Tipo ?>
	<form id="frmcadastro" name="frmcadastro" method="post" action="?pg=cad" >
		<table width="50%" border="2" align="center" id="tbcad" >
			<tr>
				<td colspan="3">
		...
		<table width="" border="2" align="center" id="tbcad" >
			...
			?>	
				<tr>
					...
					<td align="left" >
						<input name="data" id="data1" type="text" size="6" maxlength="10" readonly="readonly" value="<? echo $data_atual?>" onkeypress="autoTab(this, event); return event.keyCode != 13; "/>
						<input name="cod_tab_mix" type="hidden" size="6" maxlength="10" readonly="readonly" value="<? echo $cod_tab_cab?>"/>
					</td>
					<td  colspan="5"><? echo busca_nome_mercado($_SESSION['mercado_id']);?></td>
			...
			?>
				<tr>
					<td colspan="2">
						...
						<? echo $linha_prod['cod_produto']; ?>		
					</td>
					<td colspan="3">
						<input type="hidden" size="100" name="nome_produto<? echo $qt_prod; ?>"value="<? echo utf8_encode($linha_prod['nome_produto']); ?>" onkeypress="autoTab(this, event); return event.keyCode != 13; "/>
						<? echo utf8_encode($linha_prod['nome_produto']); ?>
					</td>
					<td colspan="1">
						<input type="text" size="5" maxlength="5" name="quebra<? echo $qt_prod;?>" value="<? echo $qt_prod;?>" onkeypress="autoTab(this, event); return event.keyCode != 13; "/>
					</td>
				</tr>
				<? 
				$qt_prod ++;
