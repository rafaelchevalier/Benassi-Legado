...
adiciona ($_REQUEST['nome'],$_REQUEST['nivel_usuario'], $_REQUEST['login'],md5($_REQUEST['passwordConfirm']),$_REQUEST['email'],$_REQUEST['dia'],$_REQUEST['mes'],$_REQUEST['telefone'],$_REQUEST['celular'],$_REQUEST['radio'],$_REQUEST['setor']);
	echo"
	<META HTTP-EQUIV=REFRESH content='0; URL=../login.php?pg=login'>
