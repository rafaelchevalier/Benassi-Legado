...
if ($tipo_email == "abre_chamado"){
	...
	//====================================================
	$email_destinatario = $email_usuario.";pedro@benassirj.com.br;rafael@benassirj.com.br;robson@benassirj.com.br;jcarlos@benassirj.com.br"; // qualquer email pode receber os dados
	$email_reply = ""; 
