	...
	<div class="breadcrumbs">
		<div class="container">
			...
			<ul class="pull-right breadcrumb">		
				<li><a href="cvp.php?pg=cad">Cadastro</a></li>
				<li><a href="cvp.php?pg=con">Consulta</a></li>
			</ul>
		</div>
	</div>
					...
					<div class="row">
						<section class="col col-4">
							...
							<label class="input">
								...
								<input type="text" autocomplete="off" name="embalagem" id="start" value="<? if (!empty($_REQUEST['embalagem'])){echo $_REQUEST['embalagem'];}if (empty($_REQUEST['embalagem'])){echo converte_data($data_atual);}?>" required onkeypress="autoTab(this, event); return event.keyCode != 13;" placeholder="Data Embalagem">
							</label>
						</section>
						<section class="col col-4">
							...
							<label class="input">
								<i class="icon-append fa fa-calendar"></i>
								<input type="text" autocomplete="off" name="validade" id="finish" value="<? if (!empty($_REQUEST['validade'])){echo $_REQUEST['validade'];}if (empty($_REQUEST['validade'])){echo converte_data($data_atual);}?>" required onkeypress="autoTab(this, event); return event.keyCode != 13;" placeholder="Data Validade">
							</label>
						</section>
						<div class="col col-4">
						...
						?>
							<tr>
								...
								<? 	if ($filt_qualidade_exclui == true){?>
										...
										<a href="http://rasp.net.br/benassi/2.0/cvp.php?pg=cad_avaliacao&id=<? echo $linha['id']?>" ><button class="btn-u btn-u-dark-blue"  type="button"><i class="fa fa-magic"></i></button></a>
								<? 	}?>	
								</td>
