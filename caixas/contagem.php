...
<h2>Contagem</h2>  
 ...
 <table width="477" border="1" align="center" cellspacing="0">
   ...
   <tr>
     ...
     <td><input type="text" name="recebida" id="cadbaixa" onkeypress="autoTab(this, event); return event.keyCode != 13; " maxlength="9" size="37"  />
     *</td>
   </tr>
   <tr>
     <td><div align="right">Quantidade Estoque na Loja:</div></td>
     <td><input type="text" name="quantidade" id="cadquantidade" onkeypress="autoTab(this, event); return event.keyCode != 13; " maxlength="9" size="37"  />
     *</td>
   </tr>
   <tr>
     <td><div align="right">Caixas enviadas</div></td>
     <td><input type="text" name="baixa" id="cadbaixa" onkeypress="autoTab(this, event); return event.keyCode != 13; " maxlength="9" size="37"  />
     *</td>
   </tr>
   <tr>
     <td><div align="right">Placa do caminhão:</div></td>
     <td><input type="text" name="placa" id="campoPlaca" onkeypress="autoTab(this, event); return event.keyCode != 13; " maxlength="8" size="37"   />
     *</td>
   </tr>
   <tr>
...
<!-- *********************** fim  cadastro Contagem Usuários ************************* -->
 ...
 <table width="476" border="1" cellspacing="0" align="center">
   ...
   <tr>
     <td><div align="right">Caixas Recebidas</div></td>
     <td><input type="text" name="recebida" onkeypress="autoTab(this, event); return event.keyCode != 13; " id="cadbaixa" maxlength="9" size="37"  />
     *</td>
   </tr>
   <tr>
     <td><div align="right">Quantidade Estoque na Loja:</div></td>
     <td><input type="text" name="quantidade" onkeypress="autoTab(this, event); return event.keyCode != 13; " id="cadquantidade" maxlength="9" size="37" />
     *</td>
   </tr>
   <tr>
     <td><div align="right">Caixas enviadas</div></td>
     <td><input type="text" name="baixa" onkeypress="autoTab(this, event); return event.keyCode != 13; " id="cadbaixa" maxlength="9" size="37"  />
     *</td>
   </tr>
   <tr>
     <td><div align="right">Placa do caminhão:</div></td>
     <td><input type="text" name="placa" onkeypress="autoTab(this, event); return event.keyCode != 13; " id="campoPlaca" maxlength="8" size="37" />
     *</td>
   </tr>
   <tr>
     <td><div align="right">Data Atual</div></td>
...
<form id="frmcadastro" name="frmcadastro" method="post" action="include/alterar.php?funcao=altera_contagem&id=<? echo $id ?>" style="text-align:right">
 <table width="" border="1" cellspacing="0" align="center">
   ...
   <tr>
     <td><div align="right">Placa do caminhão:</div></td>
     <td><input type="text" name="placa" id="campoPlaca" disabled maxlength="8" size="31" value="<? echo $linha['placa'];?>" onKeyPress="mascara(this, '###-####')"  /></td>
   </tr>
...
?>
 ...
 <table width="100%" border="1" cellspacing="0" id="tabela_servidor" align="center" bgcolor="#E0FFFF" style="page-break-before: auto;" >
  <tr>
  	<td colspan="14"><span class="style5"><? echo $ordem?></span></td>
  </tr>
  <tr>
		<? if ($_SESSION['nivel_usuario_caixa'] == 0){ //FILTRO PARA LIBERAR APENAS PARA USUÁRIOS COM NÍVEL DE ACESSO MASTER ?>
    <th width="5%" id="opcao_tb">OPÇÃO</th>
		<? }
...
//****************	Legenda do tipo de filtro escolhido	****************************
	?>
			<? if ($filt1 != ""){ ?>
            <span class="style4"> <? echo "Relatório de: ".converte_data($filt1)."  até  ".converte_data($filt2);   }
            if ($filt3 != "" ){echo " - ".$filt3; }
            if ($filt4 != ""){echo " - ".$filt4; }
            if($filt5 == 1){ 
            echo " - Somente com devolução";
            } ?>
            </span>   
...
// Fim Puxa contagem anterior
    ...
    <td<? if($ult_estoque_erro == "1"){ ?> id="destaque_vermelho"<? }?>><? echo $baixa; 
			if($linha['erro_contagem'] == "1"){ ?> <a href="contagem.php?pg=consulta_erro"><img src="../images/exc.png" width="20px" alt="erro contagem" /></a><? }?></td>
    ...
    <th id="opcao_tb"></th>
	  ...
	  <? if ($_SESSION['nivel_usuario_caixa'] < 1){ ?>
	   ...
	   <? echo "Total Entradas: ".$total_loja;?>&nbsp;</th>
    	...
    	<th width="10%" id="th_funcionario"><? echo $total_enviadas;?>&nbsp;</th>
    	<th width="8%" id="th_estoque"><? echo $total_estoque;?>&nbsp;</th>
...
<table width="550" border="0" cellspacing="0" align="center">
  ...
  <tr>
	<td>Email Destinatário</td>
	<td colspan="3"><input name="email_envio" size="40" maxlength="200" /></td>
  </tr>
  <tr>
    <td colspan="4" align="center"><input type="submit" name="btfiltro1" id="btfiltro1" value="Filtrar" /><input type="reset" name="btlimpar" id="btlimpar" value="Limpar" /></td>
...
<span class="style5"></span><span class="style5"><? echo $ordem?></span>
 <table width="300px" border="1" cellspacing="0" id="tabela_servidor" align="center" bgcolor="#E0FFFF" >
   <tr>
...
while($linha_erro_contagem = mysql_fetch_array($sql_erro_contagem)){
	...
	$qtd_contagem = $linha_erro_contagem['recebida'];
}
	?>
...
<!-- *********************** EXIBIÇÃO ERROS ************************* -->
<?
if($pg == "consulta_erro"){//Pendente terminar...
...
<table id="tabela_servidor" width="100%" bgcolor="666666">
	<tr>
    	<th width="5%">LOCALIZADOR</th>
        <th width="15%">DATA CONTAGEM</th>
    	<th width="60%">MERCADO</th>
        <th width="10%">QTD BONO</th>
        <th width="10%">QTD FÍSICO</th>
    </tr>
<? 
$sql = mysql_query("select * from contagem where erro_contagem ='1' order by data_erro_contagem ");
$cont = mysql_num_rows($sql);
	while($linha = mysql_fetch_array($sql)){
?>
	<tr>
    	<td><? echo $linha['id'];?></td>
        <td><? echo converte_data($linha['data_erro_contagem']);?></td>
    	<td><? echo $linha['mercado'];?></td>
        <td><? echo $linha['acerto_erro_contagem'];?></td>
        <td><? echo $linha['baixa'];?></td>
    </tr>
	<? }// Fecha consulta contagens com erro ?>
    <tr>
    	<td colspan="2"><? echo "Total erro contagem: ".$cont;?></td>
        <td colspan="3"></td>
    </tr>
