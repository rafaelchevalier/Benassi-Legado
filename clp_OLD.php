...
<h1>Cadastro</h1> 
 ...
 <table border="2" align="center" id="tbcad">    
   ...
   <tr>
     ...
     <th rowspan="6">M<br />A<br />N<br />G<br />A</th>
     <td>PAREDE</td>
     	<td align="left">
...
<!-- ************************* COZINHA INDUSTRIAL ************************* -->
   ...
   <tr>
     ...
     <th rowspan="6">G<br />A<br />L<br />P<br />Ã<br />O</th>
     <td>BALANÇAS</td>
     	<td align="left">
   ...
   <tr>
     <td>Vazamento de Áqua(Manitenção Hidráulica)</td>
     	<td align="left">
...
<tr>
   ...
   <tr>
   		<th colspan="2" rowspan="2"> OBS Geral</th>
        <td colspan="3" rowspan="2"><textarea name="obs" cols="50" rows="3" id="obs"></textarea></td>
        <td>Data:</td>
...
<tr>
   ...
   <tr>
   	 <th colspan="3">ÁREA DE MANUTENÇÃO</th>
     <td><textarea name="area_manutencao_obs" cols="40" rows="2" id="area_manutencao_obs"><? echo utf8_encode($linha['area_manutencao_obs'])?></textarea></td>
   ...
   <tr>
   		<th colspan="2" rowspan="2"> OBS Geral</th>
        <td colspan="3" rowspan="2"><textarea name="obs" cols="50" rows="3" id="obs">
        <? echo utf8_encode($linha['obs'])?></textarea></td>
        <td>Data:</td>
        <td colspan="2" align="left">
